...
class TestDisplayModes:
    ...
    def test_set_display_mode_returns_true(self, bridge):
        result = bridge.set_display_mode("cee-lo", "off")
...
class TestVisibilityGating:
    ...
    def test_on_mode_allows_surface(self, bridge):
        bridge.set_display_mode("cee-lo", "on")
        msg = SurfaceMessage(
            agent_id="cee-lo",
            from_agent="proteus",
            content="test",
    ...
    def test_on_mode_allows_surface_2(self, bridge):
        bridge.set_display_mode("cee-lo", "on")
        msg = SurfaceMessage(
            agent_id="cee-lo",
            from_agent="proteus",
...
class TestIntegration:
    def test_full_cycle(self, bridge):
        ...
        # Set mode to on
        assert bridge.set_display_mode("cee-lo", "on") is True
        assert bridge.get_display_mode("cee-lo") == "on"
